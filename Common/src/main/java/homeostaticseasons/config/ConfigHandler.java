...
public class ConfigHandler {
    ...
    public static final class Client {
        ...
        private static final String[] defaultBlacklistBiomes = new String[] {
        ...
        Client(WhiteNoiseConfigSpec.Builder builder) {
            ...
            blacklistFoliageColor = builder
                ...
                .defineListAllowEmpty(blacklistFoliageColorList, getDefaultBlacklistBiomes(), resourceLocationValidator);
            blacklistGrassColor = builder
                .comment(getTranslation("blacklistgrasscolor"))
                .defineListAllowEmpty(blacklistGrassColorList, getDefaultBlacklistBiomes(), resourceLocationValidator);
        ...
        public static boolean isBlacklistFoliageColorBiome(Holder<Biome> biomeHolder) {
            if (biomeHolder.unwrapKey().isPresent()) {
                return CLIENT.blacklistFoliageColor.get().contains(biomeHolder.unwrapKey().get().identifier().toString());
            }
        ...
        public static boolean isBlacklistGrassColorBiome(Holder<Biome> biomeHolder) {
            if (biomeHolder.unwrapKey().isPresent()) {
                return CLIENT.blacklistGrassColor.get().contains(biomeHolder.unwrapKey().get().identifier().toString());
            }
        ...
        public static boolean isBlacklistBirchColorBiome(Holder<Biome> biomeHolder) {
            if (biomeHolder.unwrapKey().isPresent()) {
                return CLIENT.blacklistBirchColor.get().contains(biomeHolder.unwrapKey().get().identifier().toString());
            }

            return false;
        }

        private static Supplier<List<? extends String>> getDefaultBlacklistBiomes() {
            return () -> Arrays.asList(Client.defaultBlacklistBiomes);
        }
